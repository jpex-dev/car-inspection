    ...
    <style>
       .input-group {
        ...
        .dropdown-content {
            ...
            right: 0;; /* Alinha com a borda esquerda do elemento pai */
        }
        ...
        <div class="dropdown" id="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
                ...
                <select name="category" id="category" placeholder="Categoria*" required disabled>
                    ...
                    <option value="6">Quadriciclo</option>
                    <option value="7">Reboque</option>
                    <option value="8">Semi-Reboque</option>
                ...
                <select name="motive" id="motive" placeholder="Motivo*" required disabled>
                    ...
                    <option value="6">Insp. téc.min.na estr.deter.p/imt</option>
                    <option value="7">Reinsp.p/atrib.nova matricula</option>
                    <option value="8">Reinspeção extraordinária</option>
                </select>
                ...
                <script>
                    ...
                    function insertApp() {
                        ...
                        var url =
                            'https://edigcia.ediprinter.pt/edigciaappointmentapi/InsertAppointment/' +
                            encodeURIComponent('80d2f00e2937f6cca61189d13b9e0c7d95f5c01a4f21e0daa8be14a8') +
                            '/1/' +
                            encodeURIComponent(formatted_date) +
                            '/' +
